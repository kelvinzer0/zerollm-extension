...
export const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    newChatSelector: "a[href='/new'], button[aria-label*='New chat'], [aria-label*='Start new chat']",
    ...
    streamSelector: "button[aria-label*='Stop response'], button[aria-label*='Stop'], .stop-button, button[aria-label*='Stop generating']",
    doneSelector: "button[aria-label*='Send Message']:not([disabled]), button[aria-label*='Send']:not([disabled]), button:has(svg path[d*='M2 12']):not([disabled]), .font-claude-message",
    resultContainerSelector: ".font-claude-message, [data-is-streaming='false'], .standard-markdown, [class*='prose']",
  ...
  },
  {
    ...
    urlPattern: "*://*.qwen.ai/*",
    newChatSelector: "[aria-label*='新建对话'], [aria-label*='New chat'], button:has-text('新建对话')",
    startChatSelector: "textarea[placeholder*='问问'], textarea[placeholder*='Type a message'], textarea, [contenteditable='true']",
    continueChatSelector: "textarea[placeholder*='问问'], textarea[placeholder*='Type a message'], textarea, [contenteditable='true']",
    streamSelector: "button[class*='stop'], button:has([class*='stop']), [aria-label*='停止生成']",
    doneSelector: "button[class*='send']:not([disabled]), button[type='submit']:not([disabled]), button:has(svg):not([disabled])",
    resultContainerSelector: "[class*='message-item-assistant'], [class*='chat-item--assistant'], [class*='contentBlock'], .markdown",
  ...
  },
  {
    ...
    newChatSelector: "[aria-label*='新建对话'], button:has-text('新建对话')",
    ...
    streamSelector: "button[class*='stop'], [aria-label*='Stop']",
    doneSelector: "button[class*='send']:not([disabled]), button[type='submit']:not([disabled])",
    resultContainerSelector: "[class*='assistant'], [class*='message-content'], .markdown",
