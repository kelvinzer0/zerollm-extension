...
export const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    responseScope: "main, [class*='chat-message-list'], [class*='conversation'], [role='main'], [class*='chat-container']",
  ...
  },
  {
    ...
    responseScope: "main, [role='main'], [class*='chat-list'], [class*='conversation'], [class*='message-list']",
    newChatSelector: "[aria-label*='新建对话'], button:has-text('新建对话'), button:has-text('New chat')",
