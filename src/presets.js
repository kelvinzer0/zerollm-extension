...
export const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    doneSelector: "button[aria-label*='Send']:not([disabled]), button[class*='surface-action-primary']:not([disabled]), form button[type='submit']:not([disabled]), .send-button:not([disabled]), button.send-btn:not([disabled])",
    resultContainerSelector: "article[data-align='left'] div.prose, article[data-align='left'], div.prose, .prose, [class*='styles_tableMarkdown'], .message-ai .content, .chat-bubble-bot .text, .assistant-message, .message-content, [class*='bot-message'], [class*='ai-message'], .markdown",
  ...
  },
  {
    ...
    newChatSelector: "a[href='/'], button[aria-label*='New chat'], [aria-label*='Start new chat'], button[aria-label*='Obrolan baru']",
    startChatSelector: "div.tiptap.ProseMirror.query-bar-editor, div.ProseMirror[contenteditable='true'], textarea[placeholder*='Ask Grok'], textarea[placeholder*='Ask anything'], textarea, [contenteditable='true'], div[role='textbox']",
    continueChatSelector: "div.tiptap.ProseMirror.query-bar-editor, div.ProseMirror[contenteditable='true'], textarea[placeholder*='Ask Grok'], textarea[placeholder*='Ask anything'], textarea, [contenteditable='true'], div[role='textbox']",
    streamSelector: "button[aria-label*='Stop'], button[aria-label*='Berhenti'], button[aria-label*='stop'], [aria-label*='Stop generating']",
    doneSelector: "button[aria-label*='Kirim']:not([disabled]), button[aria-label*='Ask']:not([disabled]), button[aria-label*='Send']:not([disabled]), button[type='submit']:not([disabled]), button:has(svg path[d*='M2 12']):not([disabled])",
    resultContainerSelector: ".message-bubble, .response-content-markdown, .prose-chat, [data-role='assistant'], [class*='assistant'], [class*='response'], article, .prose, [class*='markdown']",
  ...
  },
  {
    ...
    newChatSelector: "a[href='/'], button:has-text('New Thread'), button:has-text('Obrolan baru'), button:has-text('新建问题')",
    startChatSelector: "#ask-input, div#ask-input, textarea#ask-input, textarea[placeholder*='Ask'], div[contenteditable='true'], [role='textbox'], textarea",
    continueChatSelector: "#ask-input, div#ask-input, textarea#ask-input, textarea[placeholder*='Ask'], div[contenteditable='true'], [role='textbox'], textarea",
    streamSelector: "button[aria-label*='Stop'], button[aria-label*='Berhenti'], button[aria-label*='stop'], [aria-label*='Stop generating']",
    doneSelector: "button[aria-label*='Kirim']:not([disabled]), button[aria-label*='Submit']:not([disabled]), button[aria-label*='Send']:not([disabled]), button[aria-label*='Search']:not([disabled]), button:has(svg):not([disabled])",
  ...
  {
    id: "kimi",
    name: "Kimi AI (Moonshot / Global)",
    enabled: true,
    defaultUrl: "https://www.kimi.ai/?chat_enter_method=new_chat",
    newChatUrl: "https://www.kimi.ai/?chat_enter_method=new_chat",
    urlPattern: "*://*.kimi.ai/*, *://*.moonshot.cn/*",
    responseScope: "main, [role='main'], [class*='chat-session'], [class*='chat-content'], [class*='conversation']",
  ...
  {
    id: "doubao",
    name: "Dola AI / Doubao (ByteDance)",
    enabled: true,
    defaultUrl: "https://www.dola.com/chat",
    newChatUrl: "https://www.dola.com/chat",
    urlPattern: "*://*.dola.com/*, *://*.doubao.com/*",
    responseScope: "main, [role='main'], [class*='chat-list'], [class*='message-list'], [class*='conversation']",
    newChatSelector: "a[href*='/chat'], [data-testid='new_chat_button'], button:has-text('开启新对话'), button:has-text('Obrolan Baru'), a[href='/chat/']",
    startChatSelector: "div.tiptap.ProseMirror[contenteditable='true'], [contenteditable='true'], textarea[placeholder*='问豆包'], textarea[placeholder], textarea",
    continueChatSelector: "div.tiptap.ProseMirror[contenteditable='true'], [contenteditable='true'], textarea[placeholder*='问豆包'], textarea[placeholder], textarea",
    streamSelector: "button#flow-end-msg-send:has(svg rect), button[class*='stopBtn'], [aria-label*='停止'], button[aria-label*='Stop']",
    doneSelector: "button#flow-end-msg-send:not([disabled]):not(.cursor-not-allowed), button[id*='flow-end-msg-send']:not([disabled]), button[class*='sendBtn']:not([disabled]), button[type='submit']:not([disabled])",
    resultContainerSelector: "div[data-target-id='message-box-target-id']:not(:has(.justify-end)) div[data-copy-telemetry], div[class*='inner-item']:not(:has(.justify-end)), [data-testid='chat_response_content'], [class*='message-container--assistant'], [class*='answer-content'], .markdown",
    description: "ByteDance Dola AI / Doubao Web Interface (dola.com & doubao.com)"
  },
  {
    id: "glm",
    name: "GLM / Zhipu AI",
    ...
    newChatUrl: "https://chatglm.cn/main/alltoolsdetail?lang=en",
    urlPattern: "*://chatglm.cn/*, *://*.chatglm.cn/*",
    responseScope: "main, [role='main'], [class*='chat'], [class*='conversation']",
    newChatSelector: ".new-session, [aria-label*='新建对话'], [aria-label*='New chat'], button:has-text('新建'), div:has-text('New Chat')",
    startChatSelector: "textarea.scroll-display-none, textarea[placeholder*='GLM'], textarea[placeholder], textarea, [contenteditable='true'], div[role='textbox']",
    continueChatSelector: "textarea.scroll-display-none, textarea[placeholder*='GLM'], textarea[placeholder], textarea, [contenteditable='true'], div[role='textbox']",
    streamSelector: ".enter-icon-container.stop, [class*='stop'], .enter-icon-container:has(svg rect), [class*='stop-btn'], button[aria-label*='Stop']",
    doneSelector: "div.enter-icon-container:not(.empty), .enter-icon-container:not(.empty), button[class*='send']:not([disabled]), button[type='submit']:not([disabled]), button:has(svg):not([disabled])",
    resultContainerSelector: ".answer-content-wrap, .answer-content, .answer, .chat-assistant, [class*='assistant'], .markdown, [class*='answer-text']",
  ...
  },
  {
    ...
    newChatSelector: "button[data-testid='sidebar-new-conversation-nav-item'], [aria-label*='Obrolan baru'], [aria-label*='New topic'], [aria-label*='Percakapan baru'], button[aria-label*='New chat']",
    startChatSelector: "textarea#userInput, textarea[id='userInput'], textarea[placeholder*='Copilot'], textarea[placeholder*='Beri pesan'], textarea[placeholder*='Ask'], textarea, div[contenteditable='true']",
    continueChatSelector: "textarea#userInput, textarea[id='userInput'], textarea[placeholder*='Copilot'], textarea[placeholder*='Beri pesan'], textarea[placeholder*='Ask'], textarea, div[contenteditable='true']",
    streamSelector: "button[data-testid='stop-button'], button[aria-label*='Stop responding'], button[aria-label*='Stop'], button[aria-label*='Berhenti'], button[title*='Stop']",
    doneSelector: "button[data-testid='submit-button']:not([disabled]), button[aria-label*='Kirim pesan']:not([disabled]), button[aria-label*='Submit']:not([disabled]), button[aria-label*='Send']:not([disabled]), button[title*='Submit']:not([disabled]), button:has(svg):not([disabled])",
    resultContainerSelector: "div[data-testid='ai-message'] div[class*='ai-message-item'], div[data-testid='ai-message'], div[data-content='ai-message'], cib-message-group[source='bot'], div[class*='response'], .prose, .markdown",
  ...
  },
  {
    ...
    newChatUrl: "https://poe.com/",
    urlPattern: "*://poe.com/*",
    responseScope: "main, [role='main'], [class*='ChatMessages'], [class*='conversation']",
    newChatSelector: "a[href='/'], [class*='ChatHeader_clearButton'], [aria-label*='Clear context'], button[aria-label*='New chat']",
    startChatSelector: "textarea[class*='GrowingTextArea'], textarea[class*='ChatMessageInput'], textarea[placeholder*='Start a new chat'], textarea[placeholder*='Talk'], textarea, [contenteditable='true']",
    continueChatSelector: "textarea[class*='GrowingTextArea'], textarea[class*='ChatMessageInput'], textarea[placeholder*='Start a new chat'], textarea[placeholder*='Talk'], textarea, [contenteditable='true']",
    streamSelector: "button[class*='ChatMessageStopButton'], button[data-button-stop='true'], button[aria-label*='Stop'], button[class*='StopButton']",
    doneSelector: "button[data-button-send='true']:not([disabled]), button[aria-label='Send message']:not([disabled]), button[class*='ChatMessageSendButton']:not([disabled]), button[type='submit']:not([disabled])",
    resultContainerSelector: "[class*='ChatMessage_chatMessage']:not(:has([class*='rightSideMessageWrapper'])) [class*='Markdown_markdownContainer'], [class*='Message_botMessage'], [class*='ChatMessage_messageRow']:not(:has([class*='rightSideMessageWrapper'])) [class*='Markdown'], .markdown",
  ...
  },
  {
    ...
    newChatUrl: "https://aistudio.xiaomimimo.com/#/",
